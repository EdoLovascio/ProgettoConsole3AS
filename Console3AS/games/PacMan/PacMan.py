...
while schermata == "istruzioni":
     for event in pygame.event.get():
        ...
        testoIstruzioni1 = font.render("Muovi PacMan usando il joystick",True,"white")
        testoIstruzioni2 = font.render("Mangia le bacche speciali per poter mangiare i fantasmi,",True, "white")
        testoIstruzioni3 = font.render("altrimenti scappa da loro",True, "white")
        testoIstruzioni7 = font.render("Mangia tutte le bacche per vincere",True, "white")
        ...
        screen.blit(testoIstruzioni7,(SCREEN_WIDTH // 2 - testoIstruzioni7.get_width() // 2, SCREEN_HEIGHT // 3 - testoIstruzioni7.get_height() // 2 + 130))
