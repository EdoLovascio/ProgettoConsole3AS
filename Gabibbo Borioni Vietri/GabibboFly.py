...
gravità = 5    # forza con cui il corpo viene spinto verso il basso
salto = 10      # potenza per ogni tocco di spazio
...
while running:
    ...
    for muro_x, muro_height in muri:         #permette di creare i due muri 
        ...
        if player_rect.colliderect(muro1) or player_rect.colliderect(muro2) or y < 20 or y > SCREEN_HEIGHT:  #prende in considerazione i nemici, se li colpisci finisce il gioco
